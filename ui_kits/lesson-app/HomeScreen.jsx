  ...
  return (
    <main className="home">
      <div className="copy">
        ...
        <p className="lede">Eight lessons. Eight quizzes. No filmmaking background required — just the movies you've already loved.</p>
        <div className="ctas">
          <Btn kind="primary" onClick={onStart}>Start practice →</Btn>
          <Btn kind="ghost" onClick={onQuiz}>Skip to quiz</Btn>
        </div>
        <div className="meta-row">
          <div className="item"><span className="num">08</span><span className="lbl">Movements</span></div>
          <div className="item"><span className="num">08</span><span className="lbl">Quiz Rounds</span></div>
          <div className="item"><span className="num">20</span><span className="lbl">Minutes</span></div>
        </div>
      </div>
      <div className="hero">
